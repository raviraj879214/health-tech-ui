    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] m-4">
        <div className="relative w-full p-4 overflow-y-auto bg-white no-scrollbar rounded-3xl dark:bg-gray-900 lg:p-11">
          ...
          <form onSubmit={handleSubmit(onUpdate)} className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
            <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  className="h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs cursor-not-allowed opacity-60 dark:bg-gray-900 dark:text-white/60"
                />
              </div>
