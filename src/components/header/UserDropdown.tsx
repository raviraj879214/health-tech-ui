...
export default function UserDropdown() {
  ...
  const getinfo = async ()=>{
    const resemail = await fetch("/api/auth/get-email");
    const resfirstname = await fetch("/api/auth/get-firstname");
    const reslastname = await fetch("/api/auth/get-lastname");

    const adminemail = await resemail.json();
